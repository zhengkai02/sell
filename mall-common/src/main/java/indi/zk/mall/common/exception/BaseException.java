...
public class BaseException extends Exception implements Serializable {
    ...
    public BaseException(ErrorMessage errorMessage) {
        this(errorMessage.getCode(), errorMessage.getMessage(), errorMessage.getType(), null, null, null, null);
    }
    ...
    public BaseException(BaseMessageIntf baseMessageIntf) {
        this(baseMessageIntf.getStatus(), baseMessageIntf.getMessage(), INNER_ERROR, null, null, null, null);
    }
    ...
    public String getMessage() {
        ...
        if (message == null) {
            ...
            if (code != null) {
                message = getStringForMsg(message);
            }
        }
        else if (code != null) {
            message = getStringForMsg(message);
    ...
    private String getStringForMsg(String message) {
