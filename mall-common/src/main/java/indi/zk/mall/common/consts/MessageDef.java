package indi.zk.mall.common.consts;
...
public class MessageDef {
     ...
     * 对车企支付异步回调
     */
    public static String ORDER_PAY_CALLBACK_QUEUE;

    public static String ORDER_PAY_CALLBACK_TOPIC;

    /**
     * 对车企的流量开通通知
     */
    public static String FLOW_OPEN_NOTIFY_QUEUE;

    public static String FLOW_OPEN_NOTIFY_TOPIC;
    ...
    private void init() {
        ...
        ORDER_PAY_CALLBACK_QUEUE = prefix + "ORDER_PAY_CALLBACK_QUEUE";
        ORDER_PAY_CALLBACK_TOPIC = prefix + "ORDER_PAY_CALLBACK_TOPIC";
        FLOW_OPEN_NOTIFY_QUEUE = prefix + "FLOW_OPEN_NOTIFY_QUEUE";
        FLOW_OPEN_NOTIFY_TOPIC = prefix + "FLOW_OPEN_NOTIFY_TOPIC";
    }
}
